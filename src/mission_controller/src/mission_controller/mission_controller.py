...
class MissionController(Plugin):
    ...
    def _parse_args(self, argv):
        ...
        parser = argparse.ArgumentParser(prog="mission_controller", add_help=False)
    ...
    def add_arguments(parser):
        ...
        group.add_argument('missiontypes', type=argparse.FileType('r'), nargs='*', default=[], help="Mission Types")
